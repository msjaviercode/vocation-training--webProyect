...
public class Notificacion {
    ...
    private final String TABLA = "Notificacion";
    ...
    private String asunto, mensaje, enlace;
    ...
    public Notificacion(int id, Busqueda b) throws SQLException {
        switch (b) {
            case ID:
                sql = "Select from_id, to_id, fecha_enviado, asunto, mensaje, enlace FROM " + TABLA + " where id=?";
                break;
            case FROM:
                sql = "Select id, to_id, fecha_enviado, asunto, mensaje, enlace FROM " + TABLA + " where from_id=?";
                break;
            case TO:
                sql = "Select from_id, id, fecha_enviado, asunto, mensaje, enlace FROM " + TABLA + " where to_id=?";
                break;
        }
        establecerConexion();
    ...
    public Notificacion(int from_id, int to_id, Date fecha_enviado, String asunto, String mensaje, String enlace) throws SQLException {
        sql = "Insert INTO " + TABLA + " (from_id, to_id, fecha_enviado, asunto,mensaje,enlace) VALUES(?,?,?,?,?,?) ";
        establecerConexion();
        stm = conexion.con.prepareStatement(sql);
     ...
     * @throws java.sql.SQLException
     */
    public String getEnlace() throws SQLException {
        getAtributo(Parametro.ENLACE);
        return enlace;
    }
